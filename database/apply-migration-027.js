...
async function applyMigration() {
  try {
    ...
    const migrationPath = path.join(__dirname, 'migrations', '027_create_applications_by_address_stats_function.sql');
    const sql = fs.readFileSync(migrationPath, 'utf8');

    console.log('🚀 Applying migration 027...');
    console.log('Creating function: get_applications_by_address_stats()');
